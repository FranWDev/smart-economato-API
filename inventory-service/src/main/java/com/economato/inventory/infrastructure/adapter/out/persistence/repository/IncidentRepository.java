...
public interface IncidentRepository extends JpaRepository<Incident, Long>, JpaSpecificationExecutor<Incident> {
    ...
    @Query("""
            ...
            ORDER BY
                CASE i.severity
                    WHEN com.economato.inventory.domain.model.IncidentSeverity.ALTA THEN 3
                    WHEN com.economato.inventory.domain.model.IncidentSeverity.MEDIA THEN 2
                    WHEN com.economato.inventory.domain.model.IncidentSeverity.BAJA THEN 1
                    ELSE 0
                END DESC,
                i.createdAt DESC
            """)
