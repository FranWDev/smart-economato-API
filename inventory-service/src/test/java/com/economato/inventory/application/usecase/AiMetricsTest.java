...
class AiMetricsTest {
    ...
    void smgCompression_recordsDurationAndEntityCounter() {
        ...
        SemanticMemoryGraphService service = new SemanticMemoryGraphService(
                ...
                extractor,
                enricher,
                new com.economato.inventory.application.usecase.smg.TopicClusterer(props),
                new com.economato.inventory.application.usecase.smg.IntentDetector(new com.economato.inventory.infrastructure.config.ai.AiIntentProperties()),
