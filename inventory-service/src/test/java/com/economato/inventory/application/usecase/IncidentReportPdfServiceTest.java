...
import com.economato.inventory.application.dto.response.UserSummaryDTO;
...
import com.economato.inventory.infrastructure.adapter.out.external.reports.IncidentReportPdfService;
...
class IncidentReportPdfServiceTest {
    ...
    void setUp() {
        ...
        var reverseTraceability = mock(com.economato.inventory.application.dto.response.ReverseTraceabilityDTO.class);
