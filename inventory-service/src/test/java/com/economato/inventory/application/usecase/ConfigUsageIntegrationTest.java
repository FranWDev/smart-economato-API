...
class ConfigUsageIntegrationTest {
    ...
    void productService_ShouldAcceptConfiguredUnit() throws Exception {
        ...
        lenient().when(productMapper.toResponseDTO(entity)).thenReturn(new com.economato.inventory.application.dto.response.ProductResponseDTO());
    ...
    private static void setLastActivity(UserPresenceService service, String username, String sessionId, LocalDateTime time) throws Exception {
        ...
        field.setAccessible(true);
        java.util.concurrent.ConcurrentHashMap<String, java.util.concurrent.ConcurrentHashMap<String, com.economato.inventory.application.dto.presence.UserSessionInfo>> map =
                (java.util.concurrent.ConcurrentHashMap<String, java.util.concurrent.ConcurrentHashMap<String, com.economato.inventory.application.dto.presence.UserSessionInfo>>) field.get(service);
