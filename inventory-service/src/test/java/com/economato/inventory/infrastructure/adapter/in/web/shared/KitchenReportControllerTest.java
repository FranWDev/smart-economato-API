...
class KitchenReportControllerTest {
    ...
    void testExportPdf_generatesRealPdf() {
        KitchenReportResponseDTO mockResponse = KitchenReportResponseDTO.builder()
                ...
                .totalExpiredWasteCost(BigDecimal.valueOf(12.50))
                .totalWasteCost(BigDecimal.valueOf(5.00))
                .totalSales(BigDecimal.valueOf(300.00))
                .grossProfit(BigDecimal.valueOf(106.50))
                .netProfit(BigDecimal.valueOf(89.00))
